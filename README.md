...
Output:
> _Começo da chamada (5)_ \
> _Começo da chamada (4)_ \
> _Começo da chamada (3)_ \
> _Começo da chamada (2)_ \
> _Começo da chamada (1)_ \
> _Começo da chamada (0)_ \
> _Saída do (0)_ \
> _Saída do (1)_ \
> _Saída do (2)_ \
> _Saída do (3)_ \
...
# Stack Overflow
Caso você tenha feito todos os desafios, você conseguiu fazer um loop infinito que causou _**core dumped**_, mas porquê esse loop infinito não continuou para sempre que nem no `for`?
...
Antes de tudo, _Stack_ é a tradução de pilha, mas quando pensar na _Stack_, pense numa _pilha de livros_, e não em uma _pilha elétrica_.
